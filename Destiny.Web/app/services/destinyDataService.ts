...
class DestinyDataService implements IDestinyDataService
{
    ...
    private destinyLinks = {
        icons: {
            damageTypeIcons: {
                regular: {
                    arc: "/content/images/damageTypeIcons/regular/2_arc.png",
                    solar: "/content/images/damageTypeIcons/regular/3_solar.png",
                    void: "/content/images/damageTypeIcons/regular/4_void.png"
                },
                transparent: {
                    arc: "/content/images/damageTypeIcons/transparent/2_arc.png",
                    solar: "/content/images/damageTypeIcons/transparent/3_solar.png",
                    void: "/content/images/damageTypeIcons/transparent/4_void.png"
                }
            },
            booleanIcons: {
                trueIcon: "/content/images/boolean/true.png",
                falseIcon: "/content/images/boolean/false.png"
            }
        },
        databases: {
    ...
    public getAchievementHashes(): Array<string>
    {
        const achievementHashes = <Array<string>>[];
        for (var itemNumber of this.achievements)
        {
            achievementHashes.push(itemNumber.hash);
        }
        return achievementHashes;
    }

    public getAchievementNameById(id: string): string
    {
